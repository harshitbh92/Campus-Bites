...
let getRestaurantDetails = async () => {
  ...
  let url = 'http://localhost:5000/restro/get-restaurant-detail/'+id;
...
let getMenuItemList = async () => {
  ...
  let url = 'http://localhost:5000/restro/get-menu-item-list/' +id;
  let { data } = await axios.get(url);
  console.log(data);
              ...
              <div className="col-12">
                ...
                <div className="d-flex justify-content-between border-bottom">
                  <ul className="list-unstyled d-flex gap-3 ">
                    <li className="text-white">Overview & Contact</li>
                  </ul>
                  <a
                ...
                <div className="over-view">
                  ...
                  <p className="mb-0 fw-bold text-white">Cuisine</p>
                  <p className="text-white">
                    {rDetails.cuisine}
                  </p>

                  <p className="mb-0 fw-bold text-white">Average Cost</p>
                  <p className="text-white">₹ {rDetails.min_price} for two people (approx.)</p>
                </div>

                <div className="over-view">
                  <p className="mb-0 fw-bold text-white">Phone Number</p>
                  <p className="text-white">+{rDetails.contact_number}</p>

                  <p className="mb-0 fw-bold text-white">Address</p>
                  <p className="text-white">

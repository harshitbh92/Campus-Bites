...
const Header = () => {
    ...
    return (
        ...
        <header>
            <span className="logo">
                <Link className="logo text-light" to="/">CampusBites</Link>
            </span>
            {
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <span>Already have an account ?</span> <button className="btn text-success text-decoration-underline" data-bs-target="#loginModal" data-bs-toggle="modal">Login</button>
                        </div>
                    </div>
                </div>
            </div>
            <div className="modal fade" id="loginModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabIndex="-1">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <span>Don't have an account ?</span> <button className="btn text-primary text-decoration-underline" data-bs-target="#registerModal" data-bs-toggle="modal">Register</button>
                        </div>
                    </div>
                </div>
            </div>
